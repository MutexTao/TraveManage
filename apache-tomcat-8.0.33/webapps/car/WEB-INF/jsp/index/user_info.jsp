...
<div class="user_info" style="margin-top: 10px">
    ...
    <div class="user_info_cont clear">
        ...
        <ul class="userinfo_left fl">
            <li class="active" ><span class="icon_user"></span><a href="http://localhost:8088/user/updateView">个人信息</a></li>
...
<script>
    function updta() {
        ...
        console.log(param);
        $.post("http://localhost:8088/user/update",param,function(result){
            if(result.success){
                alert("更新成功,数据将在下次登录时更新");
            }
