        ...
        <div class="left_form">
            ...
            <form class="edit_user_form" method="post" action="/User/editcustomdemand/id/801" style="padding-top:0;">
                ...
                <table width="100%">
                    ...
                    <c:if test="${cus.adminReply!=null}">
                        <tr>
                            <td class="need td_w_120"></td>
                            <td class="user_form_txt verticaltop">管理员回复：</td>
                            <td class="user_form_input" colspan="2">
                                <textarea class="user_inputxt" style=" min-height:100px; width: 450px" name="remark" placeholder="管理员回复" maxlength="255">${cus.adminReply}</textarea>
                            </td>
                            <td>
