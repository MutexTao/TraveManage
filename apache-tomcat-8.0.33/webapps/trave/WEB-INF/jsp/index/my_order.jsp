...
<div class="user_info">
    ...
    <div class="user_info_cont clear">
        ...
        <ul class="userinfo_left fl">
            <li ><span class="icon_user"></span><a href="http://localhost:8088/user/updateView">个人信息</a></li>
            <!--<li  ><span class="icon_msg"></span><a href="/User/message">我的消息</a></li>-->
            <li class="active"  ><span class="icon_order"></span><a href="http://localhost:8088/productOrder/orderView">我的订单</a></li>
            <li  ><span class="icon_custom"></span><a href="http://localhost:8088/customization/listView">我的定制</a></li>
        ...
        <div class="userinfo_right fr userorder">
            <ul class="user_right_nav">
                ...
                <li class="user_right_tab tab_m">数量</li>
            </ul>
            <c:forEach items="${orderLists}" var="item" >
                <div class="n_userorder_list">
                    <p class="n_userorder_tips">
                        ...
                        <a href="http://localhost:8088/productOrder/detailView?pid=${item.pid}&oid=${item.oid}" class="userorder_view">查看详情</a>
                    </p>
                    <div class="n_order_info clear">
                        <div class="n_order_info_tips">
                            ...
                            <a href="http://localhost:8088/product/detailView/${item.pid}" class="n_order_title ellipsis_2">${item.title}</a>
                            <p class="n_order_price_s"></p>
                        </div>
                        <div class="n_order_time">
                            <p class="n_order_time"><fmt:formatDate value="${item.stratDate}" pattern="yyyy-MM-dd"/></p>
                        </div>
                        <div class="n_order_price">
                            <p class="n_order_price">${item.price}</p>
                        </div>
                            <!--订单状态-->
                        <div class="n_order_num">
                            <p class="n_order_num">${item.pruductNum}</p>
                        </div>
                            <!--订单操作-->
