...
<script type="text/javascript">
    function getByDays(obj){
        ...
        var url="http://localhost:8088/product/list2";
        var data={
            size:5,
...
<div class="discovery_banner customtailor_banner theme-banner">
    <div class="custom_banner_wrap" style="height: 70px">

        <div id="input_Group">
            <ul>
                <li class="show"><input type="text" id="keyword" placeholder="你要去哪儿？"><span class="indexIcon"  id="searchIcon"></span>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="custom">
        <div class="custom-around">
            <div class="custom-top">
                ...
                <a class="theme-feature"  href="http://localhost:8088/productlistView"> <p class="all_r">更多&gt;</p></a>
            </div>
            <div class="tour-content ">
                <div class="ct-cn">
                    <ul class="ct-lg" id="recommend-content">
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="custom-around">
            <div class="custom-top">
                ...
                <a class="rim-all" href="http://localhost:8088/productlistView"> <p class="all_r">更多&gt;</p></a>
            </div>
            <div class="tour-content ">
                <div class="ct-cn">
        ...
        <div class="custom-around">
            <div class="custom-top">
                ...
                <a class="civil-all" href="http://localhost:8088/productlistView"> <p class="all_r">更多&gt;</p></a>
            </div>
            <div class="tour-content ">
                <div class="ct-cn">
...
<script>
    ...
    function init(){
        ...
        url="http://localhost:8088/product/hot";
        data={
            size:5,
        };
        $.post(url,data,function(result){
        ...
        var url="http://localhost:8088/product/recommend";
        $.post(url,data,function(result){
            showDataHtml4(result);
        });
    }
    ...
    function showDataHtml1(obj){
        ...
        $.each(obj,function(i,item){
            html+=`<li>
                   <a href="http://localhost:8088/product/detailView/`+item.pid+`" class="ct-img">
                        <img class="lazy" src="`+item.mainImage+`" >
                    </a>
                    <div class="ct-td">
                        <a href="http://localhost:8088/product/detailView/`+item.pid+`" class="ct-title">`+item.title+`</a>
