...
public class SendEmailUtil {
    ...
    //发件人邮箱
    private static String myEmailAccount = "2565473515@qq.com";
    //发件人邮箱密码（授权码）
    //在开启SMTP服务时会获取到一个授权码，把授权码填在这里
    private static String myEmailPassword = "jfljtbcjqoumebbj";
    //发送邮件端口mozrwrqoubwlegei
    private static String emialPort="587";


	public static void main(String[] args) {
		try {
			sendMail("m18975461697@163.com", "标题1","测试邮件");
		} catch (Exception e) {
