...
<script>
    ...
    $(".myfile").fileinput({
        //上传的地址
        uploadUrl:"http://localhost:8088/pic/upload1",
...
<script>
    ...
    editor.customConfig.uploadImgServer = 'http://localhost:8088/pic/upload1'
    // 关闭粘贴样式的过滤
    ...
    editor2.customConfig.uploadImgServer = 'http://localhost:8088/pic/upload1'
    // 关闭粘贴样式的过滤
...
//			alert(editor.txt.html());
        ...
        console.log(data);
        var targetUrl="http://localhost:8088/manage/product/update/"+${product.pid};
        $.ajax({
            type:'post',
            url:targetUrl,
            cache: false,
