...
<div id="Carousels" class="row">
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item">
                <img src="/images/test2.jpg" alt="Third slide" style="width: 100%;">
            </div>
        </div>
        <!-- 轮播（Carousel）导航 -->
                ...
                <c:forEach begin='0' end='2' items='${recommendProductList}' var='item'>
                    <div class="col-xs-4 col-md-4">
                        <div class="modalImage">
                            <div class="images"><a href="http://localhost:8088/product/detailView/${item.pid}"><img src="${item.mainImage}"></a></div>
                            <div class="imageInfo">
                                <div class="viewSpots">
