        ...
        <div class="logincontainer">
            ...
            <form role="form" method="post" id="form1" onsubmit="return toVaild()">
                ...
                <div class="form-groupl">
                    <p>已有**账号<a href="http://localhost:8088/indexView" id="login"> 登录</a> &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<a href="">同意会员条款和免责声明</a> </p>
                </div>
            </form>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#send").click(function(){
            ...
            var url="http://localhost:8088/emailValidate?email="+email;
            $.get(url);
    ...
    $(function toVaild(){
        $("#registerBtn").click(function(){
            ...
            var data = $("#form1").serialize();
            console.log(data);
            var targetUrl ="http://localhost:8088/user/register";
