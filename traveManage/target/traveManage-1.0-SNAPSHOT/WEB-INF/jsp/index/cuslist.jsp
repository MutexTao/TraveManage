...
<div class="user_info">
    ...
    <div class="user_info_cont clear">
        ...
        <ul class="userinfo_left fl">
            ...
            <li  ><span class="icon_order"></span><a href="http://localhost:8088/productOrder/orderView">我的订单</a></li>
            <li  class="active" ><span class="icon_custom "></span><a href="http://localhost:8088/customization/listView">我的定制</a></li>
            ...
            <c:forEach items="${customizations}" var="item" >
                <div class="n_order_info clear">
                    ...
                    <div class="n_user_operation">
                        ...
                        <c:if test="${item.adminReply!=null}">
                            <a>管理员有回复</a>
                        </c:if>
                        <a  target="_blank" href="http://localhost:8088/customization/detailView/${item.id}" class="n_btn_normal n_btn_warn">查看详情</a>
                    </div>
                </div>
